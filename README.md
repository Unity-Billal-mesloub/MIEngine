...
In Visual Studio Code, MIEngine also powers the 'cppdbg' debug adapter which is part of the [C/C++ Extension](https://github.com/Unity-Billal-mesloub/vscode-cpptools).
...
* [OpenDebugAD7](https://github.com/Unity-Billal-mesloub/MIEngine/tree/main/src/OpenDebugAD7): An adaptation layer between the [Debug Adapter Protocol](https://microsoft.github.io/debug-adapter-protocol/) and debug engines. This is what allows MIEngine to be used with Visual Studio Code.
* [SSHDebugPS](https://github.com/Unity-Billal-mesloub/MIEngine/tree/main/src/SSHDebugPS): A Visual Studio 'Port Supplier' which enables Visual Studio to attach to processes over SSH or Linux Docker and could be easily extended to support any other exe that provides a shell into a Linux container/machine.
...
* See the [wiki](https://github.com/Unity-Billal-mesloub/MIEngine/wiki) for more info.

### Contribute!
Before you contribute, please read through the [Contributing Guide](https://github.com/Unity-Billal-mesloub/MIEngine/wiki/Contributing-Code) to get an idea of requirements for pull requests. 

Want to get more familiar with what's going on in the code?
* [Pull requests](https://github.com/Unity-Billal-mesloub/MIEngine/pulls): [Open](https://github.com/Unity-Billal-mesloub/MIEngine/pulls?q=is%3Aopen+is%3Apr)/[Closed](https://github.com/Unity-Billal-mesloub/MIEngine/pulls?q=is%3Apr+is%3Aclosed)
* [Issues](https://github.com/Unity-Billal-mesloub/MIEngine/issues)
